...
public class AppTransition implements Dump {
    ...
    private void updateSettings() {
        ContentResolver resolver = mContext.getContentResolver();
        for (int i = 0; i < 10; i++) {
            mActivityAnimations[i] = Settings.Global.getInt(resolver, Settings.Global.ACTIVITY_ANIMATION_CONTROLS[i], 0);
        }
        int temp = Settings.Global.getInt(resolver, Settings.Global.ANIMATION_CONTROLS_DURATION, 0);
